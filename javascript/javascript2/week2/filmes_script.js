...
const shortTitleMovies = movies
    .filter(shortTitleMovies => shortTitleMovies.title.length < 5)
...
const longTitleMovies = movies
    .filter(longTitleMovies => longTitleMovies.title.length > 60)
    
console.log(longTitleMovies);


//// 3 MOVIES BETWEEN 1980 AND 1989
const eightiesMovies = movies
    .filter(eightiesMovies => eightiesMovies.year >= 1980 &&eightiesMovies.year <= 1989)

console.log(eightiesMovies);



//// 4 MOVIES BY RATING AVERAGE
const moviesByRatingAverage = movies.map(movies => {
  if(movies.rating >= 7){
      movies.tag = "good";
      return movies
  } else if (movies.rating >= 4 && movies.rating < 7){
    movies.tag = "average";
    return movies
  } else {
    movies.tag = "bad";
...
console.log(moviesByRatingAverage);




//// 5 Chain (filter and map movies rating more than 6)
