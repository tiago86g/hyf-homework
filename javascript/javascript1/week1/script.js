...
if ((shouldShowResultInDogYears = true)) {
  const dogFutureAge = dogYear * 7;
  console.log(
    `Your dog will be ${dogFutureAge} dog years old in ${dogYearFuture}`
  );
} else {
  console.log(
    `Your dog will be ${dogFutureAge} human years old in ${dogYearFuture}`
  );
}
